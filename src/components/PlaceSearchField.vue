            ...
            <div class="mb-3 xl:w-96">
                <div class="input-group relative flex flex-wrap items-stretch w-full mb-4">
                    <input v-model="searchQuery" type="search"
                        ...
                        placeholder="Rechercher une adresse..." aria-label="Search" aria-describedby="button-addon2"
                        ref="addressInput" />
                    <button @click="search"
...
import googlePlaces from '../composable/googlePlaces';
...
const link = `https://maps.googleapis.com/maps/api/js?key=${google_api_key}&libraries=places`;

onMounted(async () => {
    await googlePlaces(link);
    new google.maps.places.Autocomplete(<HTMLInputElement>addressInput.value);
});
